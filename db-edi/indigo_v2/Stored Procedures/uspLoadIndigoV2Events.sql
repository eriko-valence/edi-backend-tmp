...
BEGIN
	...
	INSERT ([ABST_CALC],[ADOP],[ALRM],[AMOD],[AMFR],[APQS],[ASER],[BLOG],[DORV],[ESER],[HOLD],[LDOP],[LERR],[LMFR],[LMOD],[LPQS],[LSER],[LSV],[RELT],[RTCW],[TAMB],[TVC],[ZCHRG],[ZSTATE],[ZVLVD],[_RELT_SECS],[EMD_TYPE],[DATEADDED]) 
	VALUES(
	s.[ABST_CALC],
	s.[ADOP],
	s.[ALRM],
