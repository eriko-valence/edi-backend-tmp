CREATE PROCEDURE [dbo].[getBatteryChargeHighcharts]
(
	@ESER varchar(64),
...
BEGIN
	...
	usbdg_event_cte as
	(
		select ESER, zutc_now, DATEADD(HOUR, DATEDIFF(HOUR, 0, zutc_now), 0) as 'zutc_now_hour', zbatt_chrg from [usbdg].[event] where eser = @ESER
	)
