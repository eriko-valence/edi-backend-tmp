...
BEGIN
	...
	INSERT ([ABST],[ADOP],[AID],[AMFR],[AMOD],[APQS],[ASER],[CDAT],[CID],[CNAM],[CSER],[CSOF],[DNAM],[EDOP],[EID],[EMFR],[EMOD],[EMSV],[EPQS],[ESER],[FID],[FNAM],[LDOP],[LID],[LMFR],[LMOD],[LPQS],[LSER],[LSV],[RNAM],[ACCD],[ACSV],[ALRM],[BEMD],[BLOG],[CMPR],[CMPS],[DCCD],[DCSV],[DORF],[DORV],[EERR],[FANS],[HAMB],[HCOM],[HOLD],[LAT],[LERR],[LNG],[MSW],[RELT],[RTCW],[SVA],[TAMB],[TCON],[TFRZ],[TPCB],[TVC],[_RELT_SECS],[_ABST],[DATEADDED]) 
	VALUES(
	tvp.[ABST],
	tvp.[ADOP],
	tvp.[AID],
